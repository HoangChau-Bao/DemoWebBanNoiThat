...
describe("Test suit product filter", () => {
  ...
  it("It should get product defaul 3", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "6091384c4045f5b26f8c79ad" })
      .end((err, res) => {
        res.should.have.status(200);
  ...
  it("It should get product defaul 4", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "6091384c4045f5b26f8c79ad" })
  ...
  it("It should get product defaul 5", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "6091384c4045f5b26f8c79ad" })
  ...
  it("It should get product defaul 6", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "6091384c4045f5b26f8c79ad" })
  ...
  it("It should get product defaul 7", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "6091384c4045f5b26f8c79ad" })
  ...
  it("It should get product defaul 8", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "609138654045f5b26f8c79ae" })
      .end((err, res) => {
        res.should.have.status(200);
  ...
  it("It should get product defaul 9", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "609138654045f5b26f8c79ae" })
  ...
  it("It should get product defaul 10", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "609138654045f5b26f8c79ae" })
  ...
  it("It should get product defaul 11", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "609138654045f5b26f8c79ae" })
  ...
  it("It should get product defaul 12", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "609138654045f5b26f8c79ae" })
  ...
  it("It should get product defaul 14", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "6092aa3a6643fee08ac07055" })
      .end((err, res) => {
        res.should.have.status(200);
  ...
  it("It should get product defaul 15", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
  ...
  it("It should get product defaul 16", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "609138204045f5b26f8c79ab" })
  ...
  it("It should get product defaul 17", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "6091383d4045f5b26f8c79ac" })
  ...
  it("It should get product defaul 18", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "6091383d4045f5b26f8c79ac" })
  ...
  it("It should get product defaul 19", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "6091383d4045f5b26f8c79ac" })
  ...
  it("It should get product defaul 20", (done) => {
    chai
      .request("http://localhost:3000")
      .post("/product/product-filter")
      .send({ selection: "6091383d4045f5b26f8c79ac" })
...
describe("Test suit get product by ID", () => {
  ...
  it(" should get right product by id 19", (done) => {
    chai
      ...
      .end((err, res) => {
        res.should.have.status(200);
        res.text.should.include("Nordli");
        done();
      });
  });
...
describe("Test suit search product", () => {
